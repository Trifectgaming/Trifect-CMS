...
namespace Szmyd.Orchard.Modules.Menu.Models
{
    ...
    public class AdvancedMenuItemPartRecord : ContentPartRecord
    {
        ...
        public virtual string RequiresPermission { get; set; }
        public virtual AuthenticationLevel AuthenticationLevel { get; set; }
        public virtual bool IncludeReturnUrl { get; set; }
    }
